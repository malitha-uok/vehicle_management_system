                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h5 class="mb-4">Add Vehicle Details</h5>
                            <div class="form-floating mb-3">
                                <select class="form-select" id="vehicle_type"
                                    ...
                                    <option value="5">Motor Bike</option>
                                    <option value="6">Special Purpose Vehicle</option>
                                </select>
                                <label for="vehicle_type">Vehicle Type</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text-primary" class="form-control" id="vehicle_number"
                                    placeholder="name@example.com">
                                <label for="vehicle_number">Vehicle Number</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text-primary" class="form-control" id="chassis_number"
                        ...
                        <div class="form-floating mb-3">
                            <input type="text-primary" class="form-control" id="seat_count"
